...
const BackgroundCircles = (props: Props) => {
  return (
    <motion.div 
        ...
        <div className='absolute border border-[#333333] mt-52 animate-ping rounded-full w-[250px] h-[250px] md:w-[200px] md:h-[200px] '/>
        <div className='absolute border border-[#333333] mt-52 animate-pulse opacity-100 md:opacity-0 rounded-full w-[280px] h-[280px]'/>
