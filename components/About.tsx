  ...
  return (
    <div className='w-full'>
      ...
      <motion.div
        ...
        className='flex flex-col relative h-screen max-h-[600px] text-center md:text-left md:flex-row max-w-7xl px-14 py-8 justify-evenly mx-auto items-center w-full'
      >
          <motion.div
            initial={{
              x: -200,
