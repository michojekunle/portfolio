...
const About = ({ pageInfo }: Props) => {
  ...
  return (
    <div className='w-full'>
      <h3 className='uppercase tracking-[15px] md:tracking-[20px] text-gray-500 text-2xl text-center w-full mt-11'>
         About
      </h3>
      <motion.div
        initial={{ opacity:0 }}
        ...
        className='flex flex-col relative min-h-screen text-center md:text-left md:flex-row max-w-7xl px-14 py-8 justify-evenly mx-auto items-center w-full'
      >
          <motion.div
            initial={{
              x: -200,
