...
const cv = (props: Props) => {
  return (
    <div className='bg-white p-10 max-w-[2000px] mx-auto'>
        ...
        <section className="flex flex-row items-start w-full  font-['Poppins']">
            <div className="el p-10 flex-1">
                <div className="experience">
                    <h2 className="text-[#00A390] font-medium text-[32px] tracking-widest">EXPERIENCE</h2>
                    <div className="mt-8">
                        <div className="">
                            <h4 className='capitalize text-black font-bold text-[26px]'>web developer</h4>
                        ...
                        <ul className='px-[60px] py-[20px] list-disc'>
                            <li className="text-[24px] ">Demonstrated Ability to manage multiple tasks while remaining adaptable and flexible.</li>
                            ...
                            <li className="text-[24px] ">Leveraging Mastery of Web Technologies such as HTML, CSS and JavaScript to build top quality code for diverse projects.</li>
                        </ul>
                    </div>
                    <div className="mt-8">
                        <div className="">
                            <h4 className='capitalize text-black font-bold text-[26px]'>front end developer</h4>
                            <p className='text-[26px]'> <span className='text-[#00A390]'>August 2022 - October 2022 </span> | Cryptware Systems, Lagos </p>                                
                        </div>
                        <ul className='px-[60px] py-[20px] list-disc'>
                            <li className="text-[24px] ">Translated flat designs files to clean, accessible and interactive user experiences.</li>
                            ...
                            <li className="text-[24px] ">Completed assigned tasks in a timely and efficient manner.</li>
                        </ul>
                    </div>
                    <div className="mt-8">
                        <div className="">
                            <h4 className='capitalize text-black font-bold text-[26px]'>Full Stack Web Developer trainee</h4>
                        ...
                        <ul className='px-[60px] py-[20px] list-disc'>
                            ...
                            <li className="text-[24px] ">Maintained understanding of current web technologies and programming practices through continuing education and participation in professional conferences and worskhops.</li>
                        </ul>
                    </div>
                </div>
            ...
            <div className="ccs w-[40%] bg-gray-200  h-[90vh] p-10 ">
                ...
                <div className="skills mt-[40px]">
                    <h2 className='text-[#00A390] font-medium text-[32px] tracking-widest uppercase'>skills</h2>
                    <ul className='px-[60px] py-[20px] list-disc'>
                        <li className="text-[26px] my-[10px]">Web Technologies: ReactJS, NextJS</li>
                        <li className="text-[26px] my-[10px]">Software Best Practices</li>
                        <li className="text-[26px] my-[10px]">Usability Understanding</li>
                        <li className="text-[26px] my-[10px]">System Maintenance</li>
                        <li className="text-[26px] my-[10px]">Web Architectture</li>
                        <li className="text-[26px] my-[10px]">Team Collaboration</li>
                        <li className="text-[26px] my-[10px]">Verbal and Written Communication</li>
                    </ul>
                </div>
            </div>
        </section>
